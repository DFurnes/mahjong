    ...
    return (
      <main className="game-page">
        <section className="game-card" aria-labelledby="game-heading">
          ...
          <p>
            Game mechanics are coming in the next phase. Starting now locks the rules that the
            match will use, so you can review the setup behavior first.
          </p>
  ...
  return (
    <main className="game-page">
      <section className="game-card" aria-labelledby="game-heading">
        ...
        <p className="game-card__pending">Turns, tiles, and bots arrive in Phase 2 and Phase 3.</p>
